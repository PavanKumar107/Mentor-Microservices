...
public class Swagger implements WebMvcConfigurer {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.blz.mentor.controller"))
                .paths(PathSelectors.any())
                .build()
                .apiInfo(apiInfo());
    }
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("LMS-Mentor",
                "APIs for E.",
                "1.0",
                "Terms of service",
                new Contact("LMS-Mentor", "http://blz.mentor", "gvpavangv14@gmail.com"),
                "Apache 2.0",
